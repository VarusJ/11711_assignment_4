...
df = pd.read_csv("/home/zjing2/capstone/goemotions/train_underperform_EDAaugmented.tsv", sep='\t', header=None, names=['text', 'labels'])
...
training_args = TrainingArguments(
    output_dir="./bert_carer_minor_eda/results",
    logging_dir="./bert_carer_minor_eda/logs",
